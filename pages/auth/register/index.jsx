...
const Register = () => {
  const {
    ...
    selectImage,
    dataRegister,
    function: { setImage, setSelectImage, handleChange, onSubmit, loginOauth },
  } = useAuthFunction();
          ...
          <div>
            ...
            <form className="flex flex-col gap-y-5" onSubmit={onSubmit}>
              ...
              <ButtonText
                ...
                isLoading={dataRegister?.isLoading}
                styleContainer="bg-[#6E54B5]"
              />
            </form>
            <div className="flex items-center my-4 text-gray-400">
              <div className="flex-grow border-t border-gray-600"></div>
              <span className="mx-4 font-mono text-xs">Or register with</span>
              <div className="flex-grow border-t border-gray-600"></div>
            </div>
